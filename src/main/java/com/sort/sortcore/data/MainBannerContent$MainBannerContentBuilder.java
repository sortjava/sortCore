...
public class MainBannerContent$MainBannerContentBuilder {
    ...
    public MainBannerContent$MainBannerContentBuilder genre(final String genre) {
        this.genre = genre;
        return this;
    }
    ...
    public MainBannerContent build() {
        return new MainBannerContent(this.id, this.type, this.title, this.year, this.genre, this.Url, this.imageUrl);
    }

    @Override
    public String toString() {
        return "MainBannerContent.MainBannerContentBuilder(id=" + this.id + ", type=" + this.type + ", title="
                + this.title + ", year=" + this.year + ", genre=" + this.genre + ", Url=" + this.Url + ", imageUrl=" + this.imageUrl + ")";
    }
}